...
import by.tms.task2.auth.AuthenticationService;
import by.tms.task2.auth.AuthenticationServiceImpl;

import java.util.List;

import static by.tms.task2.util.Constants.MIN_LOGIN_LENGTH;
import static by.tms.task2.util.Constants.PASSWORD_LENGTH;
